...
filenames = ['180313','180322','180327','180605','180607','180608','180612','180614','180619','180621','180626','180628','180629']
#filenames = ['180628','180629']

weight_path = '/home/projects/pcg_transform/pcg_AI/deep/PP/saved_weight/'
wfiles = os.listdir(weight_path)
...
for fn in filenames:
    ...
    for filename in filenames:
        ...
        model.load_weights(weight_path + wfile)
        ...
        plt.legend()
        plt.savefig(
            '/home/projects/pcg_transform/pcg_AI/deep/PP/result/deep_to_PP_100_distinct/' +fn+'_'+ filename + '_predict_PP.png')
        plt.close()
        #plt.show()
