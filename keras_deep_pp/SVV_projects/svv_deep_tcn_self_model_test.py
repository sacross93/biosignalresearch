...
from SVV_projects.read_SVV import *
...
bestpath = '/home/projects/pcg_transform/pcg_AI/deep/SVV/saved_weight/' + filedate + 'best_mse_tcn_SVV_t2.h5'
bestcorrpath = '/home/projects/pcg_transform/pcg_AI/deep/SVV/saved_weight/' + filedate + 'bset_mse_tcn_SVV_t2.h5'
...
for j in range(3):
    ...
    for i in range(epoch):
        ...
        history = model.fit(training_data, ty, validation_data=(validation_data, val_y),batch_size=16)
...
model.save_weights('vgglike_all_tmp.h5')
...
plt.title(filedate + 'tcn 128_8_ v2  Training and validation mean_square_error')
plt.legend()
#plt.show()
plt.savefig(
    '/home/projects/pcg_transform/pcg_AI/deep/SVV/result/self_graph_tcn02/' + filedate +'loss_val_SVV_self_128_8_t2 v2_test' + '.png')
plt.show()
plt.close()
# plt.figure()
...
plt.title("_Mean_square_error 128_8_t2 v2 test :" + str(result)[:4] + "  corr :" + str(corr)[:4])
plt.plot(pred, 'b', label="Predicted")
plt.plot(filtered_val_y, 'r', label='SVV')
#plt.xticks([i * (len(pred) // 5 - 1) for i in range(6)])
plt.legend()
plt.savefig(
    '/home/projects/pcg_transform/pcg_AI/deep/SVV/result/self_graph_tcn02/' + filedate + 'tcn 128_8 val_SVV_self_128_8_t2 v2_test' + '.png')
plt.show()
