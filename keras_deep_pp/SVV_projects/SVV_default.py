...
from SVV_projects.read_SVV import read_svv_dataset,read_sv_dataset
from keras.utils.training_utils import multi_gpu_model

# model = resnet152_model()
# model.summary()

files = ['2018-02-01', '2018-02-02', '2018-02-06', '2018-02-07', '2018-02-08', '2018-02-09', '2018-02-10', '2018-02-13', '2018-02-14']
save_path = '/home/projects/pcg_transform/pcg_AI/ml/SVV/result/graph/'



filedate = files[0]
x_data, y_data = read_svv_dataset(filedate)
training_data =x_data
ty = y_data

# validation
val_filedate = files[1]

x_data, y_data = read_svv_dataset(val_filedate)
...
bestpath = '/home/projects/pcg_transform/pcg_AI/ml/SVV/saved_weight/' + filedate + 'best_ml_predict_PP.h5'
...
plt.show()
plt.savefig(
    '/home/projects/pcg_transform/pcg_AI/ml/PP/result/graph/' + filedate + '_' + val_filedate + 'loss_val_ml_PP_' + '.png')
# plt.figure()
...
plt.plot(val_y, 'r', label='SVV')
plt.xticks([i * (len(pred) // 5 - 1) for i in range(6)])
plt.legend()
plt.savefig(
    '/home/projects/pcg_transform/pcg_AI/ml/PP/result/graph/' + filedate + '_' + val_filedate + 'val_ml_PP_' + '.png')
plt.show()
