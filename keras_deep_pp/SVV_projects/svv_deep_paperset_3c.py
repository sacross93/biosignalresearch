...
folder_name = 'apb_svv_mix_model_result01/'
...
[...]  # Architecture
adam = optimizers.Adam(lr=0.0000005, clipnorm=1.)
...
# model = model.get_layer('sequential_2')
...
for i in range(len(validation_files)):
    ...
    sql = """select distinct room_name from abp_svv_tableset where date =%s;"""
    ...
    for room in rooms:
        ...
        sql = """select file_name,EV_SVV,room_name,date,time from abp_svv_tableset where date =%s and room_name = %s and type = %s;"""
