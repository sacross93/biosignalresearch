...
savepath = '/home/projects/pcg_transform/pcg_AI/deep/SVV/result/'+'paper_signal/'
...
for i in range(len(validation_files)):
    ...
    for room in rooms:
        ...
        sql = """select file_name,EV_SVV,room_name,date from abp_svv_generator.svv_test1 where date =%s and room_name = %s;"""
