...
sql = """select file_name,EV_SVV from abp_svv_generator2.abp_svv_dataset where date >=%s and date <=%s order by date,file_name;"""
...
for i in range(len(validation_files)):
    ...
    sql = """select distinct room_name from abp_svv_generator2.abp_svv_dataset where date =%s;"""
    ...
    for room in rooms:
        ...
        sql = """select file_name,EV_SVV,room_name,date,time from abp_svv_generator2.abp_svv_dataset where date =%s and room_name = %s;"""
