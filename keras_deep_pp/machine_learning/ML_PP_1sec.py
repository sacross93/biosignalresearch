...
from utils.processing import get_ml_pp_all
...
x_data,y_data = get_ml_pp_all(filedate)
...
bestpath = '/home/projects/pcg_transform/pcg_AI/ml/PP/result/saved_weight/'+filedate+'best_ml_predict_PP_all.h5'
